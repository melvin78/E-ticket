...
require_once($_SERVER["DOCUMENT_ROOT"] . '/eTicket/main/Classes/Seat.php');
require_once($_SERVER["DOCUMENT_ROOT"] . '/eTicket/main/Classes/FormatSchedule.php');
if (isset($_POST['bno']) && isset($_POST['date'])) {
    ...
    $result = $seat->getSeatavailability($_SESSION['bno'], $_SESSION['from'], $_SESSION['to'], $_SESSION['date']);
    $data = $format->formatSeatsavailable($result);
    $_SESSION['se'] = $data;
}
...
<head>
    ...
    <script src="../../js/choose-seat.js"></script>
    <style>
        #COG1,#COG2,#COG3{
        ...
        *, *:before, *:after {
        ...
        .fuselage {
            border-right: 9px solid #d8d8;
            border-left: 5px solid #d8d8;
        }
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Passenger form</h5>
...
<div class="modal fade" id="error-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Missing information</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
               Whoops! You havent filled in all the details.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="row mb-3">
    ...
    <div class="col-md-6 jumbotron shadow">
        <h5>Now choose a seat from the bus layout below. Side on the left has two seats per row and the right side
        has three seats per row.This is how the seats are arranged in most of the buses. Pick any seat and click on it a form will appear. For every seat you select a form will
        appear,this is where you will fill in the details of the passenger destined to seat on that seat. After you are done click on confirm details.</h5>
    </div>
</div>
<div class="row  ">

    <div class="col-md-4  ml-2">
        <h1 class="text-center">Choose a seat from below</h1>
        <div class="container" id="seat-container">
            ...
            <div class="plane shadow">
                ...
                <ol class="cabin fuselage">
                    <div class="full-cabin" style="display: flex">
                        <div class="left-cabin">
                            <ol class="seatssidea" type="A">
                                <div class="seat">
                            ...
                            <ol class="seatssidea" type="A">
                                <div class="seat">
                                    ...
                                    <label for="1OA">10A</label>
                                </div>

                                <div class="seat">
                                    <input type="checkbox" id="1OB"/>
                                    <label for="1OB">1OB</label>
                                </div>

                            </ol>

                        </div>
                        <div class="right-cabin" style="margin-left: auto">
                            ...
                            <div style="display: flex;  margin-left: auto">
                                ...
                                <div class="seat">
                                    <input type="checkbox" id="1OD"/>
                                    <label for="10D">10D</label>
                                </div>
                                <div class="seat">
                                    <input type="checkbox" id="1OE"/>
                                    <label for="1OE">1OE</label>
                                </div>
                            </div>
    ...
    <div class="col-md-6 shadow ml-5">
        <div class="pt-4 text-center">
            <button class="btn btn-success " id="confirm-all-passenger-details"> CONFIRM DETAILS</button>

        </div>
        <p><i>After choosing a seat, fill in the details of the passengers who will be
                occupying that seat. Once all the details are correct Click on Confirm Details to confirm ticket
                purchase</i></p>
        <div style="max-height: 600px; overflow-y: auto" id="seat-form-details">
